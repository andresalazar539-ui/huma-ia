...
def _build_reply_tool_compact(
    ...
    STORE_CHECKOUT_LINES = [
        "- type='create_store_order': sku, qty, lead_name (nome completo), lead_email, cep, number (número da casa), complement (opcional), cpf (opcional). Emita QUANDO o lead disse que quer comprar um produto da loja E você já tem nome completo, e-mail, CEP e número. Rua, bairro, cidade e UF o sistema preenche pelo CEP — NÃO peça. Sistema confere estoque e preço REAIS, soma o frete, manda o card do pedido e o Pix aqui na conversa e cria o pedido pago na loja quando o Pix cair. Se falta nome, e-mail, CEP ou número, peça ANTES (um de cada vez, ou CEP e número juntos) e NÃO emita. NUNCA use generate_payment pra produto da loja e NUNCA mande o lead comprar no site quando puder fechar aqui.",
    ]
    QUALIFY_LINES = [
