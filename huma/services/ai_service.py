                ...
                **reply_property,
                ...
                "actions": {
                    ...
                    "description": (
                        ...
                        "- type='check_availability': (campos opcionais: urgency='urgent'|'normal', slots_to_find=5, requested_datetime). Emita quando o lead pedir disponibilidade OU nomear um horário específico SEM você ainda ter nome+email pra create_appointment. Se o lead nomeou um horário ('segunda 14h', 'quinta de manhã'), passe requested_datetime no MESMO formato de date_time do create_appointment — o sistema checa AQUELE horário e te diz se está livre, ocupado ou fora do expediente, com alternativas reais. Sem horário nomeado, omita requested_datetime. NUNCA diga 'vou verificar' nem invente que algo está ocupado — apenas emita a action.\n"
