...
function deriveStatus(conv) {
  if (conv.handoff_status === 'handed_off') return 'waiting';
  if (conv.stage === 'won')  return 'confirmed';
  if (conv.stage === 'lost') return 'snoozed';
  if (conv.active_appointment_datetime) return 'confirmed';
  return 'live';
}
